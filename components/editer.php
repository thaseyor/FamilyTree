  ...
  <div class='media-content'>
    ...
    <nav class='level is-mobile'>
      <div class='level-left'>
        ...
        <a class='level-item' href='person.php?id=$row[0]&change=true' aria-label='reply'>
          <span class='icon is-small'>
            <i class='fas fa-cog'></i>
          </span>
        </a>
        <a class='level-item' aria-label='reply'>
          <span class='icon is-small' onclick='connect($row[0])' id='ico_$row[0]'>
...
";
    ...
    <article class='media' style='position:fixed; margin-top:49px;'>
    <div class='media-left'></div>
  <div class='media-content'>
  <button class='button is-rounded' onclick='addBlock()' style='width:38px;color:#00ac0e'>
  <span class='icon is-small'>
